	...
	handleSubmit: function handleSubmit(e) {
		...
		(0, _xhr2.default)({
			...
			if (err || body && body.error) {
				return body.error === 'invalid csrf' ? _this.displayError('Something went wrong; please refresh your browser and try again.') : _this.displayError(body.error);
			} else {
...
var Brand = function Brand(props) {
	...
	var logo = { src: Keystone.adminPath + '/images/logo.png' };
	//, width: 205, height: 68 };
	if (props.logo) {
